...
export declare const IPC_METHODS: readonly ["meta.handshake", "meta.health", "meta.shutdown", "meta.requestSupersede", "tool.recall", "tool.coreMemory", "tool.introspect", "tool.fetchPendingWork", "tool.commitWorkResults", "tool.createKnowledgeGems", "tool.memoryHealth", "tool.linkHierarchy", "tool.supersede", "tool.recordFinding", "tool.clusterScan", "tool.whatIsMissing", "tool.createSkill", "tool.getSkillBody", "hook.sessionStart", "hook.userPromptSubmit", "hook.preToolUse", "hook.postToolUse", "hook.stop", "hook.preCompact", "hook.postCompact", "hook.sessionEnd", "hook.taskCreated", "hook.subagentStop"];
