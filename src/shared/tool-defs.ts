  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        results: { type: "object" as const, description: "The extraction results — JSON object or plain text depending on work type" },
      },
...
export const MCP_TO_IPC_METHOD: Record<string, IpcMethod> = {
  recall: "tool.recall",
